...
public class LoginQueryServlet extends HttpServlet {  // JDK 6 and above only
   ...
   public void doGet(HttpServletRequest request, HttpServletResponse response)
	...
	//dispatcher.forward(request, response);
		...
		out.println("<form method=\"get\" action=\"http://localhost:9999/gameserver/loginquery.html\"><input type=\"submit\" value=\"Try Again\"></form><form method=\"get\" action=\"http://localhost:9999/gameserver/createaccount.html\"><input type=\"submit\" value=\"Sign Up\"></form>");
